    ...
    try {
     ...
     if(!exitsEmail){
      ...
      const mailOptions = {
        ...
        html: '<p style="font-size: 15px; color: #002140; font-weight: 500;">Chúng tôi đã nhận được yêu cầu đặt lại mật khẩu Facebook của bạn. Nhập mã đặt lại mật khẩu sau đây:</p>' +
          '<p><strong style="font-size: 18px; color: blue;">' + token + '</strong></p>',
      }
      // Gửi email
